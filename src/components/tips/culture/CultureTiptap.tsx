...
import ResizableImage from '@/components/CommunityPage/ResizableImage';
...
interface CultureTiptapTipTapProps {
  watch: UseFormWatch<CultureData>;
  setValue: UseFormSetValue<CultureData>;
  trigger: UseFormTrigger<CultureData>;
}
